...
### Pet Shop - Admin Journey - Admin Login API
|Test Case No|Test Case Description|Pre-Conditions|Test Steps|Test Data|Expected Result|
| :---: | :--- | :--- | :--- | :--- | :--- |
|1|Generate Token by executing admin login API providing valid email and valid password|N/A|1. Open Postman Desktop Application<br>2. Create New Request<br>3. Enter EndPoint<br>4. Select REST Method as POST<br>5. Select Input Type as x-www-form-urlencoded<br>6. Enter valid email<br>7. Enter valid password<br>8. Send the Request|EndPoint: https://pet-shop.buckhill.com.hr/api/v1/admin/login<br>Method: POST<br>Email: admin@buckhill.co.uk<br>Password: admin|200 OK status code should be appeared with a token in the response body
|2|Executing admin login API providing invalid email and invalid password|N/A|1. Open Postman Desktop Application<br>2. Create New Request<br>3. Enter EndPoint<br>4. Select REST Method as POST<br>5. Select Input Type as x-www-form-urlencoded<br>6. Enter invalid email<br>7. Enter invalid password<br>8. Send the Request|EndPoint: https://pet-shop.buckhill.com.hr/api/v1/admin/login<br>Method: POST<br>Email: invalidmain@gmail.com<br>Password: invalid|422 Unprocessable Content status code should be appeared with "Failed to authenticate user" error in the response body